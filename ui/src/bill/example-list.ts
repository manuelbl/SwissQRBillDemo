...
/**
 * QR bill examples consisting of bill data and bill ID.
 */
...
const createExamples = () => {
  ...
  return [e3, e2, e1, e4, e5, e6];
}

/**
 * List of QR bill examples (bill data and bill ID)
 */
 export const ExampleList = createExamples();
